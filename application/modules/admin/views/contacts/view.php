            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                   <div class="form-group">
                       ...
                       <input type="email" name="email" value="apipmart@gmail.com" class="form-control" id="email" required>
                       <?php echo form_error('email'); ?>
                   </div>
                   <div class="form-group">
                       <label class="form-control-label" for="name">Nama pengirim:</label>
                       <input type="text" name="name" value="APIPMART" class="form-control" id="name" required>
