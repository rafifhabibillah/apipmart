        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" name="store_name" value="APIPMART" class="form-control" id="name">
            ...
            <div class="row">
              ...
              <div class="col-6">
                <div class="form-group">
                  ...
                  <input type="text" name="store_email" value="apipmart@gmail.com" class="form-control" id="email">
